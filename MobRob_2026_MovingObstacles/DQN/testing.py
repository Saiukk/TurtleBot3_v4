...
def parse_args():
	...
	parser.add_argument("--alg", type=str, default="DDQN", choices=["DDQN", "PPO_SB3"], help="Algorithm the checkpoint was trained with")
	parser.add_argument("--model_path", type=str, required=True, help="Path to the trained model checkpoint (.h5 for DDQN, .zip for PPO_SB3)")
